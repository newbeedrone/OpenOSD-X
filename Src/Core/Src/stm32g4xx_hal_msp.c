...
void HAL_DAC_MspInit(DAC_HandleTypeDef* hdac)
{
  ...
  /* USER CODE END DAC1_MspInit 0 */
    ...
    PA4     ------> DAC1_OUT1
    PA5     ------> GPIO (fan control, no longer used as DAC1_OUT2)
    */
    GPIO_InitStruct.Pin = GPIO_PIN_4;  /* Only PA4 is used for DAC1 CH1, PA5 is fan GPIO */
    GPIO_InitStruct.Mode = GPIO_MODE_ANALOG;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    HAL_GPIO_Init(GPIOA, &GPIO_InitStruct);
...
void HAL_DAC_MspDeInit(DAC_HandleTypeDef* hdac)
{
  ...
  /* USER CODE END DAC1_MspDeInit 0 */
    ...
    PA5     ------> GPIO (fan control, no longer used as DAC1_OUT2)
    */
    HAL_GPIO_DeInit(GPIOA, GPIO_PIN_4);  /* Only PA4 is used for DAC1 CH1, PA5 is fan GPIO */
